...
export default async function HomePage() {
    ...
    const theme = themeDb || {
        ...
        text_header: "#000000",
        text_header_mobile: "#000000",
        text_header_hover: "#DBC07E",
        bg_footer: "#0a0a0a",
        text_footer: "#ffffff",
        link_footer: "rgba(255,255,255,0.7)",
        accent_footer: "#DBC07E",
        bg_card: "#FDFBF7",
        text_card: "#000000",
        bg_badge: "#222222",
        text_badge: "#DBC07E",
    ...
    const hero = heroDb || {
        id: 1,
        title_en: "FIORA | Luxury Event Decor",
        title_ar: "فيورة | لتنسيق المناسبات",
    ...
    const settings = settingsDb || {
        ...
        whatsapp_msg_en: "Hello FIORA, I would like to inquire about...",
        whatsapp_msg_ar: "مرحباً فيورة، أود الاستفسار عن...",
    ...
    const about = aboutDb || {
        ...
        title_ar: "عن فيورة",
        content_en: "FIORA is a luxury event decor rental brand...",
        content_ar: "فيورة هي علامة تجارية فاخرة لتأجير ديكورات المناسبات...",
        image_url: "/about-img.jpg",
        updatedAt: new Date(),
    }

    const navbar = navbarDb || {
        id: 1,
        logo_url: "/logo.png",
        ...
        nav_how_en: "How We Work",
        nav_how_ar: "كيف نعمل",
        nav_contact_en: "Contact",
        nav_contact_ar: "اتصل بنا",
        nav_testimonials_en: "Testimonials",
        nav_testimonials_ar: "آراء العملاء",
        sticky_enabled: true,
        lang_switch_show: true,
        updatedAt: new Date(),
    }

    const footer = footerDb || {
        id: 1,
        logo_url: "/logo.png",
        description_en: "A creative studio designing elegant spaces and event experiences.",
        description_ar: "استوديو إبداعي لتصميم المساحات الأنيقة وتنسيق المناسبات.",
        copyright_en: "All rights reserved.",
        copyright_ar: "جميع الحقوق محفوظة.",
        slogan_en: "LUXURY STARTS HERE",
        slogan_ar: "الفخامة تبدأ من هنا",
        address_en: "Khartoum, Sudan",
        address_ar: "الخرطوم، السودان",
        email: "info@fiora.com",
        link1_en: "Interior Design",
        link1_ar: "تصميم داخلي",
        link2_en: "Event Styling",
        link2_ar: "تنسيق المناسبات",
        link3_en: "Space Planning",
        link3_ar: "تخطيط المساحات",
        updatedAt: new Date(),
    }
